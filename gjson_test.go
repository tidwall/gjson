...
func TestModifier(t *testing.T) {
	...
	if !ModifierExists("case", func(json, arg string) string { return "" }) {
		t.Fatalf("expected 'case' modifier exist with fn param, got not exist")
	}
	if !ModifierExists("case", nil) {
		t.Fatalf("expected 'case' modifier exist with nil, got not exist")
	}
	if ModifierExists("non_existing_case", nil) {
		t.Fatalf("expected 'non_existing_case' modifier not exist, got exist")
	}
